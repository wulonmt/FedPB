...
register(
    id='CartPoleSwingUpActionScale-v1',
    entry_point='Env.envs:CartPoleSwingUpActionScale',
    max_episode_steps=800,
)

register(
    id='CartPoleSwingUpV1WithAdjustablePole-v0',
    entry_point='Env.envs:CartPoleSwingUpV1WithAdjustablePole',
    max_episode_steps=800,
)
...
register(
    id='MountainCarActionScale-v1',
    entry_point='Env.envs:MountainCarActionScale',
...
register(
    id='PendulumActionScale-v1',
    entry_point='Env.envs:PendulumActionScale',
    max_episode_steps=200,
)
